...
The example in \Cref{fig:fmEx} illustrates such a function diagram. In this particular example, the system of \Cref{figscEx} and \Cref{fig:adEx} is used. 
