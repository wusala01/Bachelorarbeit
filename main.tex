...
This paper will focus on the question, whether conclusions can be made from this application to the more general concept of business-to-business-marketing apps. 
\paragraph{}
A review of the literature regarding the topic requirement engineering, visual design and business-to-business-marketing, describes Pohl's requirement engineering framework, dives into psychology of perception and gives a overview of marketing. 
\paragraph{} A methodological setup will be described and tested on the given case. The practical appliance will start with the definition of the context and then continue with the performance of the three main activities. An architectural concept will be created, as described above, followed by a visual concept. In a closing discussion, the attempt will be made to synthesize concepts to be taken into account when designing a B2B marketing app.
\paragraph{} This paper comes to the conclusion that not enough data was available for a conclusive opinion, but raises the hypothesis, that multi-level market analysis and great content flexibility are key for a succesfull business-to-business-marketing application.
